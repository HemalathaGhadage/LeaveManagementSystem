...
public class LeaveTypesServices(ApplicationDbContext _context, IMapper _mapper , ILogger<LeaveTypesServices> _logger) : ILeaveTypesServices
{
    ...
    public async Task<bool> CheckIfLeaveTypeNameExists(string name)
    {
        ...
        return await _context.LeaveTypes.AnyAsync(x => x.Name.ToLower() == lowercaseName);
